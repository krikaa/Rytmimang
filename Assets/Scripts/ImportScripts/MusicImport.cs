...
public class MusicImport : MonoBehaviour
{
    ...
    void Start()
    {
        string musicPath = "file://" + Application.streamingAssetsPath + "/Import/" + musicName;    //string, mis hoiab m2ngu kaustades streamingAssets/Import/ asuva muusikafaili asukohta
